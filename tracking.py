...
class LocalTrackingController:
    def __init__(self, X0, robot_spec,
        ...
        elif self.pos_controller_type == 'mpc_iccbf':
        ...
        if self.enable_rotation and self.robot_spec['model'] in ['SingleIntegrator2D', 'DoubleIntegrator2D']:
            if self.att_controller_type == 'simple':
                ...
                # print("Using Gatekeeper attitude controller with spec", self.robot_spec)
    ...
    def control_step(self):
        ...
        self.next_x_according_to_dynamics, self.yaw_input = self.robot.pseudo_step(u, self.u_att)
        # print("u_att tracking.py: ", self.u_att)
    ...
    def get_full_state(self):
        return self.next_x_according_to_dynamics, self.yaw_input # TODO: yaw pseudo is a temporary fix
...
def multi_agent_main(controller_type, save_animation=False):
    ...
    robot_spec = {
        'model': 'DoubleIntegrator2D', #'DoubleIntegrator2D'
        'w_max': 0.5,
        'a_max': 0.5,
        'sensor': 'rgbd',
        'fov_angle': 45.0,
