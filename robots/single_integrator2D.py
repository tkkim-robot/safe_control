...
class SingleIntegrator2D:
    ...
    #    raise NotImplementedError # SIngleIntegrator trigger bla bla for debugging
        return theta
    ...
    # 여기서는 위에 k_a 없애고 np.arry(0,0)

    def has_stopped(self, X, tol=0.05):
        ## Single_Integrator can always stop.
        return True # editing to True
